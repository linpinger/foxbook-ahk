...
{
   Return, DllCall("libhpdf\HPDF_UseUTFEncodings", "UInt", hDoc, "Cdecl int")
}
;----------------------------------------------------
...
HPDF_LoadPngImageFromMem(ByRef hDoc, BufAdr, BufSize) ; Version >= 2.2.0
{	; return hImage
	Return,  DllCall("libhpdf\HPDF_LoadPngImageFromMem", "UInt", hDoc, "Uint", BufAdr, "Uint", BufSize, "Cdecl int")
}
...
{
   Return, DllCall("libhpdf\HPDF_Page_CreateLinkAnnot", "UInt", hPage, "UInt", &rect, "UInt", dst, "Cdecl int")
}
